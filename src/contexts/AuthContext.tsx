...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const loginWithUsername = async (username: string, password: string) => {
    try {
      // Construct the email directly from the username.
      // This is secure because the email format is consistent across the app
      // and avoids a client-side database query before authentication.
