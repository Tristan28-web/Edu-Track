...
import { Loader2, Sparkles, Bot } from 'lucide-react'; // Added Bot icon
    ...
    <div className="space-y-6">
      ...
      {aiResponse && (
        <Card className="shadow-md">
          <CardHeader>
            <CardTitle className="text-xl font-headline text-primary/90 flex items-center gap-2">
                <Bot className="h-6 w-6" /> {/* Added Bot icon */}
                AI Generated Answer
            </CardTitle>
          </CardHeader>
          <CardContent className="prose dark:prose-invert max-w-none">
            <div className="bg-secondary/20 p-4 rounded-md"> {/* Enhanced styling for the response block */}
                {/* Render the answer which includes step-by-step explanation */}
                <div 
