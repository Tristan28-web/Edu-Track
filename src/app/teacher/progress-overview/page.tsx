...
export default function TeacherProgressOverviewPage() {
  ...
  useEffect(() => {
    if (!authUserFromContext || authUserFromContext.role !== 'teacher') {
      setIsLoading(false);
      if (authUserFromContext) setError("Accessing this page requires a teacher login.");
    ...
    const q = query(
      ...
      where("role", "==", "student"),
      where("teacherId", "==", authUserFromContext.id),
    ...
    const unsubscribe = onSnapshot(q, (querySnapshot) => {
      ...
      console.error("Error listening to students' progress:", err);
      let detailedError = "Failed to load students' progress in real-time.";
    ...
    <div className="space-y-8">
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Track overall class performance and individual student mastery.
          </CardDescription>
        </CardHeader>
      </Card>
      ...
      {isLoading && (
        <div className="flex justify-center items-center py-10">
          ...
          <p className="ml-2">Loading student progress...</p>
        </div>
      )}
      {error && (
          ...
          {studentsProgress.length > 0 ? (
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-xl font-headline text-primary/90 flex items-center gap-2">
                    <PieChart className="h-6 w-6" /> Class Mastery Distribution
                  </CardTitle>
                  <CardDescription>Overall mastery levels of your students.</CardDescription>
                </CardHeader>
                <CardContent>
                  {hasMeaningfulChartData ? (
                    ...
                    <div className="text-center text-muted-foreground py-8 space-y-2">
                      ...
                      <p className="text-sm">
                        Student mastery data will appear here once students complete lessons and quizzes.
                      </p>
                      <p className="text-xs">
                        Encourage your students to engage with the course materials!
                      </p>
                    </div>
                  )}
                </CardContent>
            ...
            <Card>
              <CardContent className="pt-6 text-center text-muted-foreground">
                No students assigned to you or no progress data available. Add students in the "Manage Students" section to begin tracking progress.
              </CardContent>
            </Card>
          )}
        </>
